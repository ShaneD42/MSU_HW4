...
startButton.addEventListener("click", setTime); // added an event listener to the start button so the timer wills set
...
let storedArray = JSON.parse(window.localStorage.getItem("highScores")); // This doesnt make sense to me
...
function setTime() { // function to start timer 
  displayQuestions(); // disPlay qu
...
function displayQuestions() {
  ...
  scoresDiv.innerHTML = ("Score: " + score); // this is what makes the score appear
